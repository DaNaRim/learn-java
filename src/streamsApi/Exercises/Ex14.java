...
public class Ex14 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, List<String>> categoryProducts = products.stream()
                .collect(Collectors.groupingBy(Product::getCategory,
                        Collectors.mapping(Product::getName, Collectors.toList())));
        
        //(Collectors.mapping) convert from <Category, List of Products> to <Category, List of Product Name>
        
        categoryProducts.forEach((category, productsNames) ->
                System.out.println("category = " + category + ", productsNames = " + productsNames));
    }
